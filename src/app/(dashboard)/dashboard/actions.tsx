...
export const getUserGroupSplits = async (user_id: string): Promise<SplitGroup[]> => {
  const supabase = createSupabaseServerClient();
...
export const getUserSplitsById = async (user_id: string, split_id: string): Promise<Split[]> => {
  const supabase = createSupabaseServerClient();
...
export const getUserSplitById = async (user_id: string, split_id: string): Promise<Split[]> => {
  const supabase = createSupabaseServerClient();
...
export const getExercisesForSplit = async (user_id: string, id: string): Promise<string[] | null> => {
  const supabase = createSupabaseServerClient();
